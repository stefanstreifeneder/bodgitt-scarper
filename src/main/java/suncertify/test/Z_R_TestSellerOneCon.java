 ...
 */
public class Z_R_TestSellerOneCon {
	 ...
	 * of progress.
	 */
	private static String progressText = "Z_R_TestSellerOneCon"
	...
	static {
    	...
    	while(idIsEntered){
    		...
    		if (inputIterations == null) {
    			...
    			final int n = JOptionPane.showConfirmDialog(null, 
    					"Z_R_TestSellerOneCon - please enter the "
    					+ "number of iterations!", 
    					 		"Z_R_TestSellerOneCon (ADMIN)",
		...
		null, "Z_R_TestSellerOneCon (SELLER) " 
		...
		final String inputAll = JOptionPane.showInputDialog(null,
				...
				+ "\nUpdate-1: D_S_R1_UP_1_ + count; Smalville; 2; Roofing; 75; "
				+ "\nUpdate-2: H_S_R1_UP_2_ + count; Myville; 23; Roofing; 85; "
		...
		System.out.println("Z_R_TestSellerOneCon has started."
		...
		try {
			...
			System.out.println("Z_R_TestSellerOneCon, main, "
		...
		if(conFailed){
			JOptionPane.showMessageDialog(null,
					"ATTENTION: Z_R_TestSellerOneCon, connection failed!"
					+ "\nProgram stops!");
			System.exit(0);
		}
    }
    ...
    public static void main(final String [] args) {
        try{
        	new Z_R_TestSellerOneCon().startTests();
    		...
    		System.out.println("Z_R_TestSellerOneCon, OOMError: " + formattedDate);
    		e.printStackTrace();
    	}  
    }
    ...
    private void startTests() {
		...
		final String formattedDate = sdf.format(d);
        System.out.println("Z_R_TestSellerOneCon has run to the end."
        ...
        final JOptionPane alert = new JOptionPane("Z_R_TestSellerOneCon has run to the end."
        		+ "\nConnection: " + client.toString()
        		+ "\nDone, Loops: " + countRuns
        		+ "\n- up 1 start: " + countUp1Start
        		+ " - up 1 end: " + countUp1End
    ...
    private class UpdatingRandomRecordThread extends Thread { 
		...
		public void run() {
			...
			recordUpdate.setName("D_S_R1_UP_1_" + countRuns);
			recordUpdate.setCity("Smallville");
			recordUpdate.setNumberOfStaff(2);
			recordUpdate.setTypesOfWork("all");
			recordUpdate.setHourlyChargeRate("$150.00");
			recordUpdate.setOwner("11");
			...
			try {
				...
				if( !((e instanceof SecurityException)
					...
					System.out.println("Z_R_TestSellerOneCon - UPDATE 1: " 
							+ countUp1End + " - " + e.getLocalizedMessage());
					if(e instanceof ConnectException){
            			displayDialog(e.getMessage(), Z_R_TestSellerOneCon.this.ip, 
            					Z_R_TestSellerOneCon.this.port, 
            					"Z_R_TestSellerOneCon - UPDATE 1",
			...
			if ((countUp1End % loopsToNesxtDisplay) == 0) {
				System.out.println("Z_R_TestSellerOneCon - UPDATE 1, start run: " 
						+ countUp1Start 
						+ " - run end: " + countUp1End 
						+ " - loops: " + countRuns
						+ " - ok: " + ok);
    ...
    private class UpdatingRecord1Thread extends Thread { 
		...
		public void run() {
            ...
            room.setName("H_S_R1_UP_2_" + countRuns);
            room.setCity("Myville");
            room.setTypesOfWork("Lausy");
            ...
            try {            	
            	...
            	if( !((e instanceof SecurityException)
            			^ (e instanceof RecordNotFoundException))) {
            		System.out.println("Z_R_TestSellerOneCon - UPDATE 2"
            				+ " - " + e);
					if(e instanceof ConnectException){
            			displayDialog(e.getMessage(), Z_R_TestSellerOneCon.this.ip,
            					Z_R_TestSellerOneCon.this.port, 
            					"Z_R_TestSellerOneCon - UPDATE 2",
            	...
            	try {
					...
					if( !((e instanceof SecurityException)
	            			^ (e instanceof RecordNotFoundException))) {
						System.out.println("Z_R_TestSellerOneCon "
								+ "- UPDATE 2 - " + e.getLocalizedMessage());
					}
				} 
            }
            countUp2End++;
			if ((countUp2End % loopsToNesxtDisplay) == 0) {
				System.out.println("Z_R_TestSellerOneCon - UPDATE 2, start: " 
						+ countUp2Start
        				+ " - run end: "+ countUp2End 
        				+ " - loops: " + countRuns
        				+ " - ok: " + updateOk);
		...
		public void run() {
            ...
            try {
            	...
            	if( !(e instanceof DuplicateKeyException)) {
            		System.out.println("Z_R_TestSellerOneCon - CREATE - " 
            				+ e.getLocalizedMessage());
            		if(e instanceof ConnectException){
            			displayDialog(e.getMessage(), Z_R_TestSellerOneCon.this.ip, 
            					Z_R_TestSellerOneCon.this.port, 
            					"Z_R_TestSellerOneCon - CREATE",
			...
			if ((countCreateEnd % loopsToNesxtDisplay) == 0) {
				System.out.println("Z_R_TestSellerOneCon - CREATE, start: " 
						+ countCreateStart 
    ...
    private class DeletingRecord1Thread extends Thread { 
		...
		public void run() {
            ...
            try {            	
            	...
            	if( !((e instanceof SecurityException)
            			^ (e instanceof RecordNotFoundException))) {
            		System.out.println("Z_R_TestSellerOneCon - DELETE"
            				+ " - " + e.getLocalizedMessage());
					if(e instanceof ConnectException){
            			displayDialog(e.getMessage(), Z_R_TestSellerOneCon.this.ip, 
            					Z_R_TestSellerOneCon.this.port, 
            					"Z_R_TestSellerOneCon - DELETE",
    ...
    private class FindingRecordsThread extends Thread { 
		...
		public void run() {
            ...
            try {  
            	...
            	if( !(e instanceof RecordNotFoundException)) {
            		...
            		if(e instanceof ConnectException){
            			displayDialog(e.getMessage(), Z_R_TestSellerOneCon.this.ip, 
            					Z_R_TestSellerOneCon.this.port, 
            					"Z_R_TestSellerOneCon - FindingRecords",
			...
			if ((countGetRecEnd % loopsToNesxtDisplay) == 0) {
				 System.out.println("Z_R_TestSellerOneCon - FindingRecords, start: " 
						 	+ countGetRecStart
    ...
    private class FindingByRecordsThread extends Thread {
		...
		public void run() {
               ...
               results = client.findByFilter(criteriaExists);
            	...
            	if( !(e instanceof RecordNotFoundException)) {
            		...
            		if(e instanceof ConnectException){
            			displayDialog(e.getMessage(), Z_R_TestSellerOneCon.this.ip, 
            					Z_R_TestSellerOneCon.this.port, 
            					"Z_R_TestSellerOneCon - FindingByRecords",
			...
			if ((countFindByEnd % loopsToNesxtDisplay) == 0) {
				System.out.println("Z_R_TestSellerOneCon - FindingByRecords, "
    ...
    private class GetValidRecsThread extends Thread {
		...
		public void run() {
            ...
            try{
            	...
            	System.out.println("Z_R_TestSellerOneCon - GetDelRecords - " 
            				+ e.getLocalizedMessage());
            	if(e instanceof ConnectException){
        			displayDialog(e.getMessage(), Z_R_TestSellerOneCon.this.ip, 
        					Z_R_TestSellerOneCon.this.port, 
        					"Z_R_TestSellerOneCon - GetDelRecords",
		...
		public void run() {
            ...
            try{
               ...
               results.size();
            	...
            	System.out.println("Z_R_TestSellerOneCon - GetLocked - " 
            				+ e.getLocalizedMessage());
            	if(e instanceof ConnectException){
        			displayDialog(e.getMessage(), Z_R_TestSellerOneCon.this.ip, 
        					Z_R_TestSellerOneCon.this.port, 
        					"Z_R_TestSellerOneCon - GetLocked",
